...
# XHS-Downloader 程序路径（从 Projects 目录引用）
XHS_DOWNLOADER_PATH = Path(r"C:\Users\admin\Projects\XHS-Downloader")

# 下载输出路径（保存到 D 盘）
DOWNLOAD_ROOT = Path(r"D:\小红书下载\_internal\Volume")

# XHS-Downloader 下载记录数据库
XHS_EXPLORE_ID_DB = DOWNLOAD_ROOT / "ExploreID.db"

# 下载目录
DOWNLOAD_DIR = DOWNLOAD_ROOT / "Download"
