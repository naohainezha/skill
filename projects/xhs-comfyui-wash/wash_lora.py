...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("\n可用LoRA模型:")
        print("  xiaolian_000001800.safetensors  - 小脸")
        print("  xiaolian2.safetensors           - 小脸2")
        print("  Z_kuanlian_000001140.safetensors - 宽脸")
        print("\n示例:")
        print("  python wash_lora.py ./filtered")
        print('  python wash_lora.py ./filtered "xiaolian_000001800.safetensors" 0.8')
        print('  python wash_lora.py ./filtered "xiaolian2.safetensors" 0.8')
        print('  python wash_lora.py ./filtered "Z_kuanlian_000001140.safetensors" 0.8')
        sys.exit(1)
