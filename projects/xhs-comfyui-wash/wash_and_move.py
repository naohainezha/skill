"""
ComfyUI洗图工具 - 筛选素材工作流
从 filtered 读取，处理保存到 processed，并自动移动
"""
                        ...
                        for node_id, node_data in outputs.items():
                            if "images" in node_data:
                                ...
                                for img_info in node_data["images"]:
                                    # img_info 格式: {"filename": "image.png", "subfolder": "", "type": "output"}
        ...
        try:
            ...
            if success and output_files:
                ...
                for src_file in output_files:
                    dest_file = self.processed_dir / src_file.name
